...
export function LoginForm({ redirectTo }: LoginFormProps) {
  ...
  // ✅ On récupère signInWithGoogle depuis le hook
      ...
      <CardContent>
        <form onSubmit={onSubmit} noValidate className="space-y-4">
          ...
          <div className="flex justify-end">
            <Link href="/forgot-password" className="text-caption text-link rounded-sm hover:underline">
        ...
        <p className="text-caption text-muted-foreground mt-6 text-center">
          New to Kloyya?{' '}
          <Link href="/signup" className="text-link rounded-sm font-medium hover:underline">
            Create an account
          </Link>
        </p>
